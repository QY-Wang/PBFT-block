...
import (
	...
	"github.com/DWBC-ConPeer/crypto/ecies"
	"github.com/DWBC-ConPeer/crypto/secp256k1"
	"github.com/DWBC-ConPeer/crypto/sha3"
...
* 传入账户私钥
 */
func LoadECDSAByPrk(prk string) (*ecdsa.PrivateKey, error) {
